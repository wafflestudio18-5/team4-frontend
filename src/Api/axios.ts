...
export const getUsers = (sorted_by: string, search: string, page = 1) =>
  new Promise((resolve, reject) => {
    axios
      .get(`api/users/`, { params: { sorted_by, search, page } })
      .then((response) => resolve(response.data))
      .catch((e) => reject(logError(e)));
  });
//POST user
export const postUser = (user: UserInterface, github_token: String) =>
  new Promise((resolve, reject) => {
...
//PUT user
export const editUserMe = (user: UserInterface) =>
  new Promise((resolve, reject) => {
    const data = user;
    axios
      .put(`api/user/me/`, data, {
...
export const login = (
  ...
  new Promise((resolve, reject) => {
    const data = github_token
      ? { username, password, github_token }
      : { username, password };
...
export const getQuestionsWithKeywords = (
  keywords: string[],
  sorted_by: string,
  page = 1,
  filter_by?: string
  ...
  new Promise((resolve, reject) => {
    ...
    axios
      .get(`api/question/search/keywords/`, {
...
export const editQuestion = (id: number, question: QuestionEditInterface) =>
  new Promise((resolve, reject) => {
    axios
      .put(`api/question/${id}/`, { data: { question } })
      .then((response) => resolve(response.data))
      .catch((e) => reject(logError(e))); //FIXME: how to handle status code 301?
  });
...
export const getAnswersOfUser = (id: number, sorted_by: string, page = 1) =>
  new Promise((resolve, reject) => {
    axios
      .get(`api/answer/user/${id}/`, { params: { page, sorted_by } })
...
export const getAnswersOfQuestion = (id: number, sorted_by: string, page = 1) =>
  new Promise((resolve, reject) => {
    axios
      .get(`api/answer/question/${id}/`, { params: { page, sorted_by } })
      .then((response) => resolve(response.data.answers))
      .catch((e) => reject(logError(e)));
  });
...
export const postAnswer = (id: number, content: string) =>
  new Promise((resolve, reject) => {
    axios
      .post(`api/answer/question/${id}/`, { content: content })
      .then((response) => resolve(response.data))
      .catch((e) => reject(logError(e)));
  });
...
export const editAnswer = (id: number, content: string) =>
  new Promise((resolve, reject) => {
    axios
      .put(`api/answer/${id}/`, { content: { content } })
      .then((response) => resolve(response.data))
      .catch((e) => reject(logError(e)));
  });
//DELETE answer
...
export const deleteAnswerAcceptance = (id: number) =>
  new Promise((resolve, reject) => {
    axios
      .delete(`api/answer/${id}/acception/`)
      .then((response) => resolve(response.data))
      .catch((e) => reject(logError(e)));
  });
...
export const getCommentsOfAnswer = (id: number, page = 1) =>
  new Promise((resolve, reject) => {
    axios
      .get(`api/comment/answer/${id}/?page=${page}`)
...
export const commentOnQuestion = (question_id: number, content: String) =>
  new Promise((resolve, reject) => {
    axios
      .post(`api/comment/question/${question_id}/`, { data: { content } })
      .then((response) => resolve(response.data))
      .catch((e) => reject(logError(e)));
  });
export const commentOnAnswer = (answer_id: number, content: String) =>
  new Promise((resolve, reject) => {
    axios
      .post(`api/comment/answer/${answer_id}/`, { data: { content } })
      .then((response) => resolve(response.data))
      .catch((e) => reject(logError(e)));
  });
//PUT comment
export const editComment = (id: number, comment: string) =>
  new Promise((resolve, reject) => {
    axios
      .put(`api/comment/${id}/`, { data: { comment } })
      .then((response) => resolve(response.data))
      .catch((e) => reject(logError(e)));
  });
//DELETE comment
...
export const rateQuestion = (id: number, rating: number) =>
  new Promise((resolve, reject) => {
    axios
      .put(`api/rate/question/${id}/`, { data: { rating } })
      .then((response) => resolve(response.data))
      .catch((e) => reject(logError(e)));
  });
export const rateAnswer = (id: number, rating: number) =>
  new Promise((resolve, reject) => {
    axios
      .put(`api/rate/answer/${id}/`, { data: { rating } })
      .then((response) => resolve(response.data))
      .catch((e) => reject(logError(e)));
  });
export const rateComment = (id: number, rating: number) =>
  new Promise((resolve, reject) => {
    axios
      .put(`api/rate/comment/${id}/`, { data: { rating } })
      .then((response) => resolve(response.data))
      .catch((e) => reject(logError(e)));
  });
...
export const getBookmarks = (sorted_by: string, page = 1) =>
  new Promise((resolve, reject) => {
    axios
      .get(`api/bookmark/user/me/`, { params: { sorted_by, page } })
      .then((response) => resolve(response.data.questions))
      .catch((e) => reject(logError(e)));
  });
export const getBookmarksOfUser = (id: number, sorted_by: string, page = 1) =>
  new Promise((resolve, reject) => {
    axios
      .get(`api/bookmark/user/${id}/`, { params: { sorted_by, page } })
      .then((response) => resolve(response.data.questions))
      .catch((e) => reject(logError(e)));
  });
//POST bookmark
export const addBookmark = (question_id: number) =>
  new Promise((resolve, reject) => {
    axios
      .post(`api/bookmark/question/${question_id}/`)
      .then((response) => resolve(response.data))
      .catch((e) => reject(logError(e)));
  });
//DELETE bookmark
export const deleteBookmark = (id: number) =>
  new Promise((resolve, reject) => {
    axios
      .delete(`api/bookmark/question/${id}/`)
      .then((response) => resolve(response.data))
      .catch((e) => reject(logError(e)));
  });
//Tag APIs
...
export const getTagsOfUser = (id: number, sorted_by: string, page = 1) =>
  new Promise((resolve, reject) => {
    axios
      .get(`api/tag/user/${id}/`, { params: { sorted_by, page } })
